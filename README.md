...
```bash
git clone https://github.com/m0r4a/alloy-config-template.git
cd alloy-config-template
...
3. Enter the Dashboard ID: **24612**.
4. Click **Load**.
5. Select the **Loki** and **Prometheus** data sources if prompted (these are automatically provisioned by the stack).
